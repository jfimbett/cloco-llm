...
|-------|---------|--------|
| **NEW ANALYSIS** | → Coder (main Claude) | Flag for user, create analysis task |
| **CLARIFICATION** | → economics-paper-writer agent | Draft rewritten section |
| **REWRITE** | → economics-paper-writer agent | Draft structural revision |
| **DISAGREE** | → User (mandatory) | Draft diplomatic pushback, flag for review |
| **MINOR** | → economics-paper-writer agent | Draft fix directly |
...
- Dispatch economics-paper-writer agent with specific instructions for each point
