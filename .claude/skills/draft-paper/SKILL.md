---
name: draft-paper
description: Draft academic economics papers by dispatching the economics-paper-writer agent. Handles section drafting, notation protocol, anti-hedging, and humanizer pass. Use when asked to "draft the paper", "write up the results", or "write the intro".
...
Draft an academic economics paper (or specific section) by dispatching the **economics-paper-writer** agent.
...
Before dispatching the economics-paper-writer:
...
Delegate to the `economics-paper-writer` agent via Task tool:
...
- This is built into the economics-paper-writer agent — no separate dispatch needed
