---
name: submit
description: Final submission verification gate. Runs replication-verifier in submission mode (10 checks), confirms aggregate score >= 95 with all components >= 80, and generates submission checklist. Use when ready to submit to a journal.
...
This triggers: econometrics-critic + debugger + academic-proofreader + replication-verifier in parallel.

### Step 3: Run Replication Audit

Dispatch replication-verifier in submission mode:
```
