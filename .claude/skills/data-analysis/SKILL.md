---
name: data-analysis
description: End-to-end data analysis dispatching Coder (main Claude) for implementation and Debugger agent for code review. Supports R, Stata, Python, and Julia. Produces scripts, tables, figures, and results summary.
...
Run an end-to-end data analysis by dispatching the **Coder (main Claude)** (implementer) and **Debugger** (code critic).
...
Delegate to the Coder (main Claude) via Task tool:
