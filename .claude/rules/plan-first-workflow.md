...
5. **Save to disk** — write to `.claude/plans/YYYY-MM-DD_short-description.md`
...
2. Create `.claude/specs/YYYY-MM-DD_description.md` using `templates/requirements-spec.md`
...
```
.claude/plans/YYYY-MM-DD_short-description.md
```
...
1. Read `CLAUDE.md` + most recent plan in `.claude/plans/`
